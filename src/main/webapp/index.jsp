...
<head>
    ...
    <title>PB Exchange rate checker</title>
</head>
<body>
            ...
            <th scope="col">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-primary" type="submit" name="form" value="form1">Submit</button>
                    </div>
                </div>
                </form>
            </th>
        ...
        <tr>
            <th scope="col">
                <form action="controller" method="post">
                    ...
                    <button class="btn btn-primary" type="submit" name="form" value="form2">Submit</button>
                </form>
            </th>
            <th>
                <label>
